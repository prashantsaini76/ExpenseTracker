  ...
  return (
    <>
      {isLoading ? (
        ...
        <div className="sm:min-h-screen sm:bg-[#181c2c] flex justify-center items-center mt-[100px] sm:mt-0">
          <div className="bg-[#080b17] text-white p-8 rounded-lg shadow-lg w-full max-w-md">
            ...
            <form onSubmit={handleAddExpense}>
              <div className="mb-4">
                ...
                <input
                  ...
                  className="w-full px-4 py-2 border border-gray-300 bg-[#181c2c] rounded-md focus:outline-none focus:ring-2 focus:ring-blue-400"
                  required
                />
              </div>
              <div className="mb-4">
                <label className="block mb-2">Debit Item</label>
                <input
                  type="text"
                  value={item}
                  placeholder="Groceries, Laundry etc"
                  onChange={(e) => setItem(e.target.value)}
                  className="w-full px-4 py-2 border bg-[#181c2c]  border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-400"
                  required
                />
              </div>
              ...
              <div className="mb-4">
                ...
                <select
                  ...
                  className="w-full px-4 bg-[#181c2c] py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-400"
                  required
                >
              ...
              <div className="flex gap-2">
                <button
                  type="submit"
                  className="bg-[#05aeee] text-white px-4 py-2 rounded-md transition duration-200"
                >
                  Add Expense
                </button>
                <button
